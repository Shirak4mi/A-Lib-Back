...
CREATE TABLE "Bussiness_type" (
    ...
    CONSTRAINT "Bussiness_type_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Business" ADD CONSTRAINT "Business_bussiness_type_id_fkey" FOREIGN KEY ("bussiness_type_id") REFERENCES "Bussiness_type"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
