...
CREATE TABLE "Barber_Status" (
    ...
    CONSTRAINT "Barber_Status_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Barber" ADD CONSTRAINT "Barber_status_id_fkey" FOREIGN KEY ("status_id") REFERENCES "Barber_Status"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
